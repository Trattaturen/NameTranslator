...
public class Translator
{
     ...
     */
    public synchronized String post(String nameToTranslate)
    {
	translatedSymbols += nameToTranslate.length();
	...
	nameToTranslate = TEXT_KEY_REQUEST + nameToTranslate;
	RequestBody body = RequestBody.create(REQUEST_MEDIA_TYPE_JSON, nameToTranslate);
