...
public class ManagerImpl implements Manager
{
    ...
    private final String QUEUE_NAME = "names";
    private final String FILE_PATH = "/home/user/source_file.txt";
    ...
    @Override public void submitTranslation(String origin, String translation)
    {
        lock.lock();
